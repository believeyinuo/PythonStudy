# -*- coding: utf-8 -*-
# @Time : 2019/10/22 4:00 下午
# @Author : szdl
# @Email : believeyinuo@163.com
# @File : mini_app_125_1.py
# @Project : PythonStudy
...
# 在切换到小程序webview时，回去匹配chrome内核的39的驱动。在切换完成之后，在打印所有的
...
# driver.find_element_by_id("com.tencent.mm:id/jd).send_keys()
time.sleep(5)
...
# 需要找到哪一个窗口有柠檬班的窗口，然后再在其下找元素操作。
# 遍历所有的handles，找到当前页面所在的handle: 如果pageSource有包含你想要的元素，就是索要找的handles
...
# 点击老师
WebDriverWait(driver, 20).until(EC.visibility_of_element_located((MobileBy.XPATH, "//*[@id=\"js-tab-bar\"]")))
WebDriverWait(driver, 20).until(EC.presence_of_element_located((MobileBy.XPATH, "//em[text()='歪歪']")))
time.sleep(0.5)
# 找到歪歪老师
